...
This protocol applies to all cross-model review calls in this skill suite:
- `/research-review` — single-pass and looped review
- `/paper-figure` — figure quality review
- `/paper-writing` (claim audit, Phase 4.7) — claim audit

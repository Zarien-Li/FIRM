...
invalidation through `evidence-lineage.md`. An invalid run is not a scientific negative.
...
Use `research-review` only when independent judgment can change a consequential
...
co-PI view; pass the evidence and unresolved design question to `method-primitive-synthesis`

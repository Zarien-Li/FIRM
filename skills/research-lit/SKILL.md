...
Update the current Program Compass only when the literature changes an incumbent,
ownership threat, accepted surface, or design assumption. Cite a primary source for
every load-bearing fact. A literature report cannot create a user constraint, close
the program, or grant paper maturity.

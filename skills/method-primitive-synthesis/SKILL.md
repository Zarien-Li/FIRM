...
description: Form, implement, ablate, repair, and simplify a load-bearing research method from a valuable known problem or natural reproduced failure. Use for a sustained construction arc, not a one-shot idea funnel or a new method after every result.
---
...
impose a fixed output template. Follow `research-review` for the verified invocation

...
- **REVIEWER_MODEL = `account-default`** — Use Codex MCP without a `model` field for figure quality review.
...
Send figure descriptions and captions to the account-default Codex reviewer:

...
description: Creates a lightweight pre-run record for an expensive or claim-defining experiment without freezing the living research thesis.
when_to_use: Use when a run is costly, decisive, or vulnerable to post-hoc reinterpretation and its configuration, forecast, comparison, and success criteria should be recorded first.
argument-hint: "[experiment ID or plan]"
---
...
Use the project's existing tracker or create a compact record beside the experiment plan:

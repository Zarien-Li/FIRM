...
This map records recurring failure patterns observed during more than **100B model tokens** of
long-horizon research work. It is not a taxonomy invented before deployment. Each category
...
| A claim survives repeated retelling but loses contact with raw evidence | Narrative consistency is confused with evidential support | Unsupported causal language enters the paper | Reconstruct claims from artifacts and verify citations through [`citation-audit`](../skills/citation-audit/SKILL.md) |
